...
public class StateController {
    ...
    //TO DELETE!!
    public String[] classes = {"101", "201", "301", "401", "501", "601", "701", "801","901"};
    ...
    public void addClassRomm(Integer [] classes){
        if(prof!=null)preference.profClassPreference.put(prof,classes);
    }
